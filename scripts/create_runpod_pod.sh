...
PROJECT_ROOT="${PROJECT_ROOT:-${RUNPOD_VOLUME_MOUNT_PATH}/ts_multimodal_LLM}"
...
WANDB_PROJECT="${WANDB_PROJECT:-fin-ts-multimodal}"
...
RUNPOD_HARD_LIMIT_SECONDS="${RUNPOD_HARD_LIMIT_SECONDS:-25200}"
RUNPOD_TERMINATE_AFTER="${RUNPOD_TERMINATE_AFTER:-7h}"
