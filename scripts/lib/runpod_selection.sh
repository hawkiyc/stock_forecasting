...
runpod_load_active_selection() {
    ...
    unset RUNPOD_SELECTION_ID RUNPOD_SELECTION_SHA256 \
        ...
        FIN_TS_DATASET_PROFILE FIN_TS_H_START STAGE1_US_SYMBOLS STAGE1_US_ETF_SYMBOLS \
    ...
    while IFS= read -r -d '' key && IFS= read -r -d '' value; do
        case "${key}" in
            ...
            RUNPOD_STAGE_CONFIG_SHA256|DATA_ROOT|FIN_TS_DATASET_PROFILE|FIN_TS_H_START|\
